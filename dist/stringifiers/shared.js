...
function thisIsNotTheEndOfThisBatch(node, parent) {
  ...
  return !node.sqlBatch && !((_ref9 = node) != null ? (_ref9 = _ref9.junction) != null ? _ref9.sqlBatch : _ref9 : _ref9) || !parent;
}

function whereConditionIsntSupposedToGoInsideSubqueryOrOnNextBatch(node, parent) {
  var _ref8;

  return !node.paginate && (!(node.sqlBatch || ((_ref8 = node) != null ? (_ref8 = _ref8.junction) != null ? _ref8.sqlBatch : _ref8 : _ref8)) || !parent);
}
...
function interpretForOffsetPaging(node, dialect) {
  ...
  if (((_ref7 = node) != null ? (_ref7 = _ref7.args) != null ? _ref7.last : _ref7 : _ref7) && !((_ref6 = node) != null ? (_ref6 = _ref6.args) != null ? _ref6.before : _ref6 : _ref6)) {
